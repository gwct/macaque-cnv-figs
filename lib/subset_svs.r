...
subsetSVs <- function(svdf){
  ...
  svdf_uniq = subset(svdf, select=c("CNV.key", "Type", "Chromosome", "Pos", "Length", "Species", "CNV.freq"))
  svdf_uniq = unique(svdf_uniq)
  
  svdf_focal_uniq = subset(svdf_focal, select=c("CNV.key", "Type", "Chromosome", "Pos", "Length", "Species", "CNV.freq"))
  svdf_focal_uniq = unique(svdf_focal_uniq)
  
  svdf_denovo_uniq = subset(svdf_denovo, select=c("CNV.key", "Type", "Chromosome", "Pos", "Length", "Species", "CNV.freq"))
